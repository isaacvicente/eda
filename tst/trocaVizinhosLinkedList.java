...
class trocaVizinhosLinkedList {
  public static void main(String[] args) {
    ...
    list.trocaComProximoVizinho(indice);
...
class LinkedList {
    ...
    public void trocaComProximoVizinho(int index) {
        // É assumido que o índice passado é sempre válido,
        // logo, não precisamos de validação.
